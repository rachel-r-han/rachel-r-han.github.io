...
<style>
/* ===========================================================
   Heritage Database — Visual Refinement
   Structure & data preserved · only presentation upgraded
   =========================================================== */
...
/* -----------------------------------------------------------
   2 · Typography — serif display headings
   ----------------------------------------------------------- */
...
/* short decorative rule after h2 */
...
/* -----------------------------------------------------------
   3 · Archive intro (subtitle under the title)
   ----------------------------------------------------------- */
...
/* -----------------------------------------------------------
   4 · Statistics strip — 4 tinted cards with icons
   ----------------------------------------------------------- */
...
.archive-stat:hover {
  ...
  box-shadow: 0 6px 16px rgba(40, 40, 40, 0.06);
}
...
.archive-stat-icon {
  ...
  flex-shrink: 0;
  background: #fff;
  box-shadow: 0 1px 3px rgba(40, 40, 40, 0.06);
}
...
.archive-stat:nth-child(1) .archive-stat-icon { color: #c89548; }

.archive-stat:nth-child(2) {
  background: #e8f1eb;
  border-color: #d6e6db;
}
.archive-stat:nth-child(2) .archive-stat-icon { color: #578a6b; }

.archive-stat:nth-child(3) {
  background: #e7eef8;
  border-color: #d4e0f0;
}
.archive-stat:nth-child(3) .archive-stat-icon { color: #4b78b3; }

.archive-stat:nth-child(4) {
  background: #eee7f4;
  border-color: #e0d5eb;
}
.archive-stat:nth-child(4) .archive-stat-icon { color: #8a6bab; }
...
/* hide the "Location:" / "Period:" prefixes */
.site-meta strong {
  display: none;
}
